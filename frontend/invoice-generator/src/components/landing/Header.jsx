                        ...
                        {isAuthenticated ? (
                            <div className="pt-2 border-t border-gray-200">
                                <Button
                                    ...
                                    className="w-full bg-gradient-to-r from-blue-950 to-blue-900 hover:bg-gray-800 text-white px-6 py-2.5 rounded-lg font-medium transition-all duration-200 hover:scale-105 hover:shadow-lg"
                                >
                                    Go to Dashboard
                                </Button>
                            </div>
                            ...
                            <>
                                <Link 
                                    to="/login"
                                    className="block w-full text-center text-black hover:text-gray-900 font-medium transition-colors duration-200 px-4 py-2"
                                >
                                    Login
                                </Link>
                                <Link
                                    to="/signup"
                                    className="block w-full text-center bg-gradient-to-r from-blue-950 to-blue-900 hover:bg-gray-800 text-white px-6 py-2.5 rounded-lg font-medium transition-all duration-200 hover:scale-105 hover:shadow-lg"
                                >
                                    Sign Up
                                </Link>
                            </>
